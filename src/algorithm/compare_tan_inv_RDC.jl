function compare_tan_inv_RDC(sys::System, BaseMVA::Float64 ,lmp_lo::DataFrame,
    lmp_hi::DataFrame, tcrdd_slack_lo::Float64, tcrdd_slack_hi::Float64,
    bid_lo::Float64, bid_hi::Float64, Pmin_orig::Float64, Pmax_orig::Float64;
    segm_bid_argmax_profit::Int64 = 50000, epsilon::Float64 = 0.01,
    print_plots::Bool = true)
    #Compare both tan_inv_RDC functions for lo and hi bid
    #------------------------------
